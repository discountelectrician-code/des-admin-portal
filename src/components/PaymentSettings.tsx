...
export default function PaymentSettings() {
  ...
  return (
    <div id="payment_settings_view" className="w-full max-w-7xl mx-auto px-1.5 pb-24 lg:pb-8 space-y-6">
      {/* Informative Warning box */}
      {!isAdmin && (
        <div className="bg-amber-50 rounded-xl p-4 border border-amber-250 text-amber-800 flex items-start space-x-3 w-full">
